...
class CV(FPDF):
    ...
    def generate(self, output_file):
        ...
        self.section_header("EXPERIENCE", self.col1_width, col1_x)
        ...
        if 'projects' in self.data and self.data['projects']:
            ...
            self.section_header("PROJECTS", self.col1_width, col1_x)
        ...
        if 'summary' in self.data and self.data['summary']:
            self.section_header("SUMMARY", self.col2_width, col2_x)
        ...
        if 'education' in self.data and self.data['education']:
            self.set_x(col2_x)
            self.section_header("EDUCATION", self.col2_width, col2_x)
        ...
        # Languages
        self.set_x(col2_x)
        self.section_header("LANGUAGES", self.col2_width, col2_x)
